// Copyright (C) 2020-2021 Parity Technologies (UK) Ltd. & Annie Lai Investments Ltd
...
//! 'Ethy' is the Benson event proving protocol
...
use benson_primitives::eth::EthyApi;
...
pub const ETHY_PROTOCOL_NAME: &'static str = "/benson/ethy/1";
