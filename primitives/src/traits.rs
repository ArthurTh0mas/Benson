// Copyright (C) 2019 Annie Lai Investments Limited
...
//! Common traits used by Benson Box.

use support::dispatch::Result;

/// A trait which enables buying some fee asset using another asset.
/// It is targeted at the CENNZX Spot exchange and the BensonExtrinsic format.
