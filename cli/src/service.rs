...
use benson_runtime::{self, opaque::Block, RuntimeApi};

use sc_executor::native_executor_instance;
pub use sc_executor::NativeExecutor;

// Benson native executor instance.
...
// Benson native executor instance with benchmarking
...
mod tests {
	...
	use benson_primitives::types::{DigestItem, Signature};
	use benson_runtime::constants::{asset::SPENDING_ASSET_ID, currency::DOLLARS, time::SLOT_DURATION};
	use benson_runtime::{opaque::Block, Address, Call, GenericAssetCall, UncheckedExtrinsic};
	use codec::Encode;
