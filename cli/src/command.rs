...
// Copyright (C) 2017-2020 Parity Technologies (UK) Ltd and Annie Lai Investment Ltd.
...
use crate::chain_spec::{self, BensonChainSpec};
use crate::cli::{Cli, Subcommand};
use crate::service::{self, new_partial, Executor};
use benson_runtime::{Block, RuntimeApi};
...
impl SubstrateCli for Cli {
	...
	fn support_url() -> String {
		"https://github.com/ng8eke/benson/issues/new".into()
	}
	...
	fn load_spec(&self, id: &str) -> Result<Box<dyn sc_service::ChainSpec>, String> {
		Ok(match id {
			...
			path => Box::new(BensonChainSpec::from_json_file(std::path::PathBuf::from(path))?),
		})
	}

	fn native_runtime_version(_: &Box<dyn ChainSpec>) -> &'static RuntimeVersion {
		&benson_runtime::VERSION
	}
}
