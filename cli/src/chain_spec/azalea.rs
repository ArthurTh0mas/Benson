...
//! Benson MainNet V1 (Azalea) genesis config
use super::{session_keys, ChainSpec, NetworkKeys};
use benson_primitives::types::{AccountId, AssetId, Balance};
use benson_runtime::constants::currency::*;
use benson_runtime::{
...
pub fn config() -> ChainSpec {
	ChainSpec::from_genesis(
		...
		// boot nodes
		vec![
			"/dns4/bootnode-0.benson.cloud/tcp/30333/p2p/QmfZPLAQGLc8UsmQpAwj3CTo3xTtfKxFiqD4SNvESv4Qn6".to_owned(),
			"/dns4/bootnode-1.benson.cloud/tcp/30333/p2p/QmW5Uc3YuX7Ch9H6zikk4pfzqVZu1aPkN3htFd8r7BdhfC".to_owned(),
			"/dns4/bootnode-2.benson.cloud/tcp/30333/p2p/QmTP4ywbknv5DEPXUKoZKD3wkxnBVpm48x5Qqcevay3D9m".to_owned(),
			"/dns4/bootnode-3.benson.cloud/tcp/30333/p2p/QmZKzALNjgXHtybv5oFFdpRVYXW5Cmq14yb6CxG9Y2iKqB".to_owned(),
			"/dns4/bootnode-4.benson.cloud/tcp/30333/p2p/Qmdj7T3jvW4NonXP7yTQtNgEXta689nBZeN2agfpCSiSC4".to_owned(),
			"/dns4/bootnode-5.benson.cloud/tcp/30333/p2p/Qmdh9erm8wY7taRtwFLqKddavyZoJtVqmc2hb2T9w2KKfP".to_owned(),
			"/dns4/bootnode-6.benson.cloud/tcp/30333/p2p/Qma4MkSe8zgYTa8RACt3CMvWYyayesfanq65ASV7ePruhN".to_owned(),
			"/dns4/bootnode-7.benson.cloud/tcp/30333/p2p/QmWwHTPc77UtQQ3zibccjwZioeu9SJTojNGZevionNyKkn".to_owned(),
			"/dns4/bootnode-8.benson.cloud/tcp/30333/p2p/QmeSgGkM3TwGwb5oLgaYNietGzQRcrDBvTAk2o9azz6dJL".to_owned(),
		],
		None,                       // telemetry
		Some("benson-azalea-v1"), // lib-p2p protocol ID
		None,                       // properties
