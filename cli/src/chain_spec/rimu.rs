...
fn network_keys() -> NetworkKeys {
	// TODO: accountId is not compatible with the latest AccountId type, need to recreate the keys
	...
	// 	),
	// ];
	// let root_key = hex!["bab8c0b3a663a84cf32aa9c12a5a2b7c8567daaf40a8765ce0abd573c0ad9e21"].into();
