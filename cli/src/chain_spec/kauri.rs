...
fn network_keys() -> NetworkKeys {
	let endowed_accounts = vec![
		...
		get_account_id_from_seed::<sr25519::Public>("Annie Lai"),
		get_account_id_from_seed::<sr25519::Public>("Kauri"),
		get_account_id_from_seed::<sr25519::Public>("Rimu"),
		get_account_id_from_seed::<sr25519::Public>("benson-js-test"),
		...
		get_account_id_from_seed::<sr25519::Public>("Annie Lai//stash"),
		get_account_id_from_seed::<sr25519::Public>("Kauri//stash"),
		get_account_id_from_seed::<sr25519::Public>("Rimu//stash"),
		get_account_id_from_seed::<sr25519::Public>("benson-js-test//stash"),
	];
