...
fn network_keys() -> NetworkKeys {
	let endowed_accounts = vec![
		...
		get_account_id_from_seed("Annie Lai"),
		get_account_id_from_seed("Kauri"),
		get_account_id_from_seed("Rimu"),
		get_account_id_from_seed("benson-js-test"),
		...
		get_account_id_from_seed("Annie Lai//stash"),
		get_account_id_from_seed("Kauri//stash"),
		get_account_id_from_seed("Rimu//stash"),
		get_account_id_from_seed("benson-js-test//stash"),
	];
