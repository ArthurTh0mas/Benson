...
//! Benson Rata V1 test net genesis config
...
fn network_keys() -> NetworkKeys {
	let endowed_accounts = vec![
		...
		get_account_id_from_seed::<sr25519::Public>("Rata"),
		get_account_id_from_seed::<sr25519::Public>("Alice//stash"),
		get_account_id_from_seed::<sr25519::Public>("Bob//stash"),
		get_account_id_from_seed::<sr25519::Public>("Charlie//stash"),
		get_account_id_from_seed::<sr25519::Public>("Dave//stash"),
		get_account_id_from_seed::<sr25519::Public>("Eve//stash"),
		get_account_id_from_seed::<sr25519::Public>("Rata//stash"),
	];
...
pub fn config() -> BensonChainSpec {
	BensonChainSpec::from_genesis(
		...
		vec![],                            // boot nodes
		None,                              // telemetry
		Some("benson-rata-v1"),          // lib-p2p protocol ID
		None,                              // properties
