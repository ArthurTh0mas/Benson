...
use benson_primitives::types::{AccountId, Balance, BlockNumber, DigestItem, FeeExchange, FeeExchangeV1};
use benson_runtime::{
...
fn generic_asset_transfer_works_with_doughnut() {
	...
	let doughnut = doughnut::make_doughnut("benson", cennznut.encode());
