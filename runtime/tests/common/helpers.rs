...
use benson_cli::chain_spec::{get_authority_keys_from_seed, AuthorityKeys};
use benson_primitives::types::{Balance, BlockNumber, Header};
use benson_runtime::{CheckedExtrinsic, Runtime, UncheckedExtrinsic};
use codec::Encode;
...
const SPEC_VERSION: u32 = benson_runtime::VERSION.spec_version;
/// The runtime tx version number for signing
const TX_VERSION: u32 = benson_runtime::VERSION.transaction_version;
