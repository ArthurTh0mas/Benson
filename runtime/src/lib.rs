...
//! The Benson runtime. This can be compiled with ``#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("benson"),
	impl_name: create_runtime_str!("benson-node"),
	authoring_version: 1,
...
type BensonDoughnut = prml_doughnut::PlugDoughnut<Doughnut, Runtime>;
...
impl additional_traits::DelegatedDispatchVerifier<BensonDoughnut> for Runtime {
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = benson_primitives::types::Block,
