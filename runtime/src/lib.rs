...
parameter_types! {
	...
	// due to Benson having a blocktime ~2x slower.
...
impl_runtime_apis! {
	...
	impl benson_primitives::eth::EthyApi<Block> for Runtime {
		fn validator_set() -> benson_primitives::eth::ValidatorSet<EthBridgeId> {
