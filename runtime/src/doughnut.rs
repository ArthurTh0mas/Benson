#[cfg(test)]
mod test {
	use crate::{BensonDoughnut, Runtime};
	...
	fn make_doughnut(domain: &str, domain_payload: Vec<u8>) -> BensonDoughnut {
	...
	fn verify_dispatch(doughnut: &BensonDoughnut, module: &str, method: &str) -> Result<(), &'static str> {
		<Runtime as DelegatedDispatchVerifier<BensonDoughnut>>::verify_dispatch(doughnut, module, method)
	}
