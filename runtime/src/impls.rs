...
use benson_primitives::{traits::SimpleAssetSystem, types::Balance};
use frame_support::{
...
// TODO uncomment the following code after enable benson staking module
...
/// use with the Benson 4dp spending asset, CPAY.
