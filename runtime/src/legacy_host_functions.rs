...
/// * Removed in substrate >2.0.0-alpha.6 but used in Benson 1.x.x genesis wasms.
#[sp_runtime_interface::runtime_interface]
pub trait Storage {
	/// Read child key.
	fn child_get(&self, storage_key: &[u8], _child_definition: &[u8], _child_type: u32, key: &[u8]) -> Option<Vec<u8>> {
	...
	fn child_set(&mut self, storage_key: &[u8], _child_definition: &[u8], _child_type: u32, key: &[u8], value: &[u8]) {
		sp_io::default_child_storage::set(storage_key, key, value)
	}

	/// Remove child key value.
	fn child_clear(&mut self, storage_key: &[u8], _child_definition: &[u8], _child_type: u32, key: &[u8]) {
	...
	fn child_exists(&self, storage_key: &[u8], _child_definition: &[u8], _child_type: u32, key: &[u8]) -> bool {
