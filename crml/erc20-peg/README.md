# ERC20 Peg
Manages a Generic Asset - ERC20 peg using the Benson ethereum bridge.
...
`yarn deploy` will send a test deposit of `123` to Benson address: `0xacd6118e217e552ba801f7aa8a934ea6a300a5b394e7c3f42cd9d6dd9a457c10` e.g.

```bash
eth_sendTransaction
  Contract call:       BensonBridge#deposit
...
## Other
Example Benson account for accepting ERC20 deposits
```
...
-> @benson/api branch with latest metadata and types
yarn build:release

@benson/types: npm link
@benson/api: npm link && npm link @benson/types
benson/cli: npm link @benson/api

replace 'rxjs/operators' with 'rxjs/operators/index.js' in packages/api/build/

benson: 0x1215b4Ec8161b7959A115805bf980e57A085c3E5
