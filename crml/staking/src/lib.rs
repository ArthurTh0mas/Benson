// Copyright 2017-2020 Parity Technologies (UK) Ltd. and Annie Lai Investments Ltd.
...
decl_storage! {
	trait Store for Module<T: Trait> as Staking {
		...
		// TODO remove the following variable when https://github.com/ng8eke/benson/issues/297
...
decl_error! {
	...
	pub enum Error for Module<T: Trait> {
		...
		DuplicateNominee,
		// TODO remove the following error when https://github.com/ng8eke/benson/issues/297
		BondingNotEnabled,
	}
}
...
impl<T: Trait> Module<T> {
	...
	/// This can also trigger a new era:
	/// 1) naturally, on the last session of an era determined by `SessionsPerEra`
	/// 2) or forced, if indicated by governance (see `Forcing`)
